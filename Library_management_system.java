...
public class Library_management_system extends JFrame implements ActionListener {
    ...
    public Library_management_system() {
        ...
        label5 = new JLabel("Publication's year");
        label6 = new JLabel("ISBN");
        label7 = new JLabel("Number of Pages");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            String[] columns = {"Book ID", "Book Title", "Author", "Publisher", "Publication's Year", "ISBN", "Number of Pages"};
